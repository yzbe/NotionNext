...
const Card = (props) => {
  ...
  return (
    <div className={className}>
      ...
      */}
      <section className="rounded-xl overflow-hidden shadow px-2 py-4 bg-white dark:bg-hexo-black-gray duration-300 hover:shadow-xl dark:hover:shadow-[0_0_20px_rgba(255,255,255,0.06)]">
        {children}
      </section>
    </div>
  )
