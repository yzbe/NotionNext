    ...
    <SmartLink href='/' passHref legacyBehavior>
      <div
        className={
          ...
          'flex flex-col justify-center items-center cursor-pointer bg-transparent lg:bg-[#9ca3af] dark:lg:bg-hexo-black-gray lg:border lg:border-gray-100 dark:lg:border-gray-700/50 lg:shadow-sm lg:hover:shadow-md lg:rounded-xl lg:py-5 lg:mb-4 lg:mx-3 lg:mt-3 lg:w-auto transform transition-all duration-300 lg:hover:-translate-y-1 dark:lg:hover:bg-gray-800 w-full space-y-3 font-bold ' +
          className
        }>
