  ...
  return (
    <>
      ...
      <div className='block md:hidden fixed top-[75px] left-[25px] z-[99]'>
        <button
          onClick={handleBack}
          /* ⭐️ 修复 1：增加 p-0 清除按钮默认内边距 */
          className='flex items-center justify-center p-0 w-10 h-10 rounded-full 
                     bg-white/40 dark:bg-black/20 backdrop-blur-xl
                     text-gray-900 dark:text-white
                     shadow-sm active:scale-95 transition-all duration-200'
        >
          {/* ⭐️ 修复 2：增加 leading-none 清除行高，并增加 pr-[2px] 将箭头往左挤一点，实现完美的光学居中 */}
          <i className='fas fa-chevron-left text-lg leading-none pr-[2px]' />
        </button>
      </div>
