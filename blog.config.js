...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'YUAN ZIBIN', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '制造业从业者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yuanzibin.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion1, 博客1', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一名机械工程师, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客',
